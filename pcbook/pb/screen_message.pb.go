...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=yenonn.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x79, 0x65, 0x6e, 0x6f, 0x6e, 0x6e, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x79, 0x65, 0x6e, 0x6f, 0x6e, 0x6e, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x1d, 0x5a, 0x1b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: yenonn.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: yenonn.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: yenonn.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: yenonn.pcbook.Screen.resolution:type_name -> yenonn.pcbook.Screen.Resolution
	0, // 1: yenonn.pcbook.Screen.panel:type_name -> yenonn.pcbook.Screen.Panel
