...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=yenonn.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x79, 0x65, 0x6e, 0x6f, 0x6e, 0x6e, 0x2e, 0x70, 0x63,
	...
	0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x1d, 0x5a, 0x1b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x79, 0x65, 0x6e, 0x6f, 0x6e, 0x6e, 0x2f, 0x70, 0x63, 0x62, 0x6f,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: yenonn.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: yenonn.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: yenonn.pcbook.Memory.unit:type_name -> yenonn.pcbook.Memory.Unit
